...
<%@ page import="com.cya.pojo.Notice,com.cya.pojo.Admin,com.cya.pojo.History,com.cya.dao.NoticeDao,com.cya.dao.BookDao,com.cya.dao.AdminDao" %>
<!DOCTYPE html>
<html>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="url" value="user/history">
